    ...
    Tables: {
      ...
      roles: {
        Row: {
          ...
          auth__entity__script__can_insert: boolean
          auth__is_active: boolean
      ...
      seed_scripts: {
        Row: {
          general__created_at: string | null
          general__created_by: string | null
          general__is_active: boolean | null
          general__order: number
          general__script_id: string
          general__seed_id: string
          general__updated_at: string | null
        }
        Insert: {
          general__created_at?: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "seed_scripts_general__script_id_fkey"
            columns: ["general__script_id"]
            isOneToOne: false
            referencedRelation: "entity_scripts"
            referencedColumns: ["general__script_id"]
          },
