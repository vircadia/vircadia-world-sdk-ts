...
const serverEnvSchema = z.object({
	...
	VRCA_SERVER_SERVICE_WORLD_TICK_MANAGER_HOST_CONTAINER_BIND_INTERNAL: z
		.string()
		.default("0.0.0.0"),
	VRCA_SERVER_SERVICE_WORLD_TICK_MANAGER_PORT_CONTAINER_BIND_INTERNAL: z.coerce
		.number()
		.default(3021),
	VRCA_SERVER_SERVICE_WORLD_TICK_MANAGER_HOST_CONTAINER_BIND_EXTERNAL: z
		.string()
		.default("0.0.0.0"),
	VRCA_SERVER_SERVICE_WORLD_TICK_MANAGER_PORT_CONTAINER_BIND_EXTERNAL: z.coerce
		.number()
		.default(3021),
