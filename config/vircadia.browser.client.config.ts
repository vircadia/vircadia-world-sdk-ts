...
const browserClientEnvSchema = z.object({
    ...
    // Web Three JS Client
    VRCA_CLIENT_WEB_THREE_JS_DEBUG: z
        .union([
            z.boolean(),
            z
                .string()
        ...
        .default(false),
    VRCA_CLIENT_WEB_THREE_JS_SUPPRESS: z
        .union([
            z.boolean(),
            z
                .string()
        ...
        .default(false),
    VRCA_CLIENT_WEB_THREE_JS_DEBUG_SESSION_TOKEN: z.string().default(""),
    VRCA_CLIENT_WEB_THREE_JS_DEBUG_SESSION_TOKEN_PROVIDER: z
        .string()
        .default("system"),

    VRCA_CLIENT_WEB_THREE_JS_META_TITLE_BASE: z.string().default("Vircadia"),
    VRCA_CLIENT_WEB_THREE_JS_META_DESCRIPTION: z.string().default("..."),
    VRCA_CLIENT_WEB_THREE_JS_META_OG_IMAGE: z
        .string()
        .default("/brand/logo_icon.webp"),
    VRCA_CLIENT_WEB_THREE_JS_META_OG_TYPE: z.string().default("website"),
    VRCA_CLIENT_WEB_THREE_JS_META_FAVICON: z
        .string()
        .default("/brand/favicon.svg"),

    VRCA_CLIENT_WEB_THREE_JS_APP_URL: z
        .string()
        .url()
        .default("https://app.vircadia.com"),

    VRCA_CLIENT_WEB_THREE_JS_DEFAULT_WORLD_API_URI: z
        .string()
        .default("localhost:3020"),
    VRCA_CLIENT_WEB_THREE_JS_DEFAULT_WORLD_API_URI_USING_SSL: z
        .union([
            z.boolean(),
            z
                .string()
    ...
    // Production Web Three JS Client
    VRCA_CLIENT_WEB_THREE_JS_PRODUCTION_CONTAINER_NAME: z
        .string()
        .default("vircadia_world_client_web_three_js_prod"),
    VRCA_CLIENT_WEB_THREE_JS_PRODUCTION_HOST_CONTAINER_BIND_EXTERNAL: z
        .string()
        .default("0.0.0.0"),
