...
<CodeBlock language="typescript" title="composables/useVircadiaContext.ts">
...
<CodeBlock language="typescript" title="composables/useEnvironmentLoader.ts">
  {useEnvironmentLoaderTs}
</CodeBlock>

### Entity (useVircadiaEntity)

<CodeBlock language="typescript" title="composables/useAvatarEntity.ts">
  {useAvatarEntityTs}
</CodeBlock>
